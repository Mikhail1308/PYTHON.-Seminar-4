...
list_1 = list(randint(1, 50) for i in range(int(input('Введите кол-во кустов N: '))))
print(f'Кусты, с количеством ягод на каждом: {list_1}')
...
print(f'Система сбора может собрать: {res} ягод')
